...
```{r echo=FALSE}
# show the differences between original and imputed
df_differences = matrix(c(mean_orig, mean_new, med_orig, med_new), ncol=2)
colnames(df_differences) <- c('mean', 'median')
rownames(df_differences) <- c('original', 'new')
df_differences
